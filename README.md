...
[![GitHub Repo](https://img.shields.io/badge/GitHub-FlowerBook--web-orange?style=flat-square&logo=github)](https://github.com/ayseguleyrice/FlowerBook-web.git)
...
- **🏆 Achievements**: Bitkilerinize baktıkça "Wise Plane Tree" gibi rütbeler kazanın ve toplulukta yükselin.
...
1. Depoyu klonlayın:
   ```bash
   git clone https://github.com/ayseguleyrice/FlowerBook-web.git
   ```
